            ...
            try {
                ...
                if(msg.type.equals("message")){
                    if(msg.recipient.equals("All")){
                        ...
                        if(!ui.map.containsKey(msg.sender)){
                            ChatFrameNoSocket chatFrameNoSocket = new ChatFrameNoSocket(ui.username,msg.sender, client);
                            ...
                            if(msg.sender.equals(ui.username)){
                                ui.map.get(msg.recipient).append(msg.content+"\n");
                            }else{
                                ui.map.get(msg.sender).append(msg.content+"\n");
                            }
                        }
